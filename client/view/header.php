<header>
        <div class="container">
            <div class="header_info">
                    <img class="logo" src="../../../thuedo/template/img/nova.png" alt="">
                    <nav class="navbar">
                ...
                <div class="search">
                    <form class="header_search" action="?mod=page&act=search&id_user=<?php echo $id_user?>" method='post'>
                            ...
                            <button class="header_search_button" type="submit"> <img src="../../../thuedo/template/icon/search.svg" alt=""></button>
                    </form>
                </div>
                <div class="user-cart">
               
                    <a class="cart" href="?mod=cart&act=list&id_user=<?php echo $id_user?>">
                        <img src="../../../thuedo/template/icon/cart.svg" alt=""><span class="cart_quantity"><?php echo $sqlCountCart?></span>
                    </a>
                    <div class="list-cart">
                        <?php                    
                         if($sqlSelectCart):
                        ...
                        <div class="list-cart-item">    
                            ...
                            <div class="cart-item-img">
                                <img src="../../../thuedo/template/img/<?php echo $item['image']?>" alt="">
                            </div>
                        </div>
                        <hr>
                        <?php
